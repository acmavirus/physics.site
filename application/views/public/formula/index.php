...
<body>
    ...
    <script>
        // Global variables
        var mmConfig = <?php echo json_encode(isset($mmConfig) ? $mmConfig : [], JSON_UNESCAPED_UNICODE); ?>;
        var currentFormula = <?php echo json_encode(isset($slug) ? $slug : 'emc2'); ?>;
        var formulaBase = <?php echo json_encode('/cong-thuc/'); ?>;
        var allFormulas = {};
                ...
                emc2: {
                    ...
                    groups: {
                        E: [{
                            ...
                            latex: 'E \approx 9\times 10^{16}\,\text{J}',
                            angle: 40,
                            radius: 140
                        }],
                        m: [{
                        ...
                        c: [{
                            latex: 'c \approx 3\times 10^{8}\,\text{m/s}',
                            angle: -40,
                            radius: 140
                        }, {
                            latex: 'c \text{ trong chân không}',
                            angle: 0,
                            radius: 160
                        }, {
                            latex: 'E = h f',
        ...
        function renderCenterNode() {
            ...
            try {
                katex.render(centerLatexRaw, centerEl, {
                    throwOnError: false,
                    displayMode: false
                });
            } catch (e) {
        ...
        function wrapCenterLatex(latex, keys) {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (tok.charAt(0) === '\\') {
                    ...
                    out = out.replace(patternCmd, function(m) {
    ...
    <script src="/assets/js/formula.js?v=2"></script>
